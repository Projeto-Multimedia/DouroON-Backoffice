...
$avatar = backpack_user()->avatar;
$link = 'http://localhost:8000/'. $avatar;
...
<li class="nav-item dropdown pr-4">
  ...
  @if($avatar)
    <img class="img-avatar" src="{{ $link }}" alt="{{ backpack_auth()->user()->name }}" onerror="this.style.display='none'" style="margin: 0;position: absolute;left: 0;z-index: 1; border-radius: 50%; width: 50px; height:40px">
  @else
